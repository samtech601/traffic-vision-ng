...
MODEL_PATH = "best1.pt"
VIDEO_PATH = "test/vecteezy_car-and-truck-traffic-on-the-highway-in-europe-poland_7957364.mp4"   # used by main.py; app.py takes an uploaded path instead — edit THIS if you change test videos, not a local copy in main.py
