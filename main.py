...
from config import (
    ...
    DETECT_W, DETECT_H, DETECT_CONF, COUNT_CONFIDENCE,
    ...
    LABEL_HISTORY_SIZE, LINE_UPPER, LINE_LOWER, MODEL_PATH, VIDEO_PATH,
    CONGESTION_THRESHOLDS, LOS_THRESHOLDS,
)
...
# CONGESTION_THRESHOLDS, and LOS_THRESHOLDS are all explicitly imported from
# config.py above — single-sourced, and explicit imports (not `import *`)
# so your editor's linter can actually resolve them instead of flagging
# false "possibly undefined" warnings.
